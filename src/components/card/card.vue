<template>
  <transition name="slider">
      <div class="card">
        <div class="wrapper" ref="wrapper">
          <div class="inner">
            <div class="title-image">
              <img src="./card.png" alt="嘉卡贷" @load="imgBS">
            </div>
            <form @submit.prevent="submit">
              <div class="content">
                ...
                <div class="progress-wrapper">
                  ...
                  <div class="num-range">
                    <div class="left-num">3000(元)</div>
                    <div class="right-num">30000(元)</div>
                  </div>
                </div>
                <div class="month">
              ...
              <div class="purpose" @click="showSelect">
              ...
              <div class="product-details" @click="showProduct">
        ...
        <popup-product ref="product"></popup-product>
...
<script type="text/ecmascript-6">
  ...
  import PopupProduct from 'base/popup-product/popup-product'
    ...
    methods: {
      ...
      submit () {
        if (this.purposeValue === '请选择') {
          ...
          this.$router.push('/recommend/card/personal-data')
        }
      },
      postdata () {

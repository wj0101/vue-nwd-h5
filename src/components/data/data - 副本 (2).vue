...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      showToggle2 () {
        this.setChoiceShowTwo(this.isShow2)
      ...
      showToggle3 () {
        this.setChoiceShowThree(this.isShow3)
      ...
      showToggle4 () {
        this.setChoiceShowFour(this.isShow4)
      ...
      ...mapMutations({
        ...
        setChoiceShowOne: 'SET_CHOICE_SHOW_ONE',
        setChoiceShowTwo: 'SET_CHOICE_SHOW_TWO',
        setChoiceShowThree: 'SET_CHOICE_SHOW_THREE',
        setChoiceShowFour: 'SET_CHOICE_SHOW_FOUR'
      })
    },
    created () {
      this.addevent()
